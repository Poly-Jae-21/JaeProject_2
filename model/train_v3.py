        ...
        for episode in range(args.max_episodes):
            ...
            for rank in range(3):
                if rank == 0:
                    ...
                    print(self.initial_observation)
                    total_local_reward, local_average_reward, _ = meta_ppo.global_evaluate(local_policy_net[rank], env, self.initial_observation, factor=factor[rank], timesteps=args.max_timesteps)
